...
pdf(load)
#dev.new()
graphics::plot(loading.x[,pcx], loading.x[,pcy], xlim = Mpc1, ylim = Mpc2, xlab = paste("w*c values ", pcx, sep=""), ylab = paste("w*c values ", pcy, sep=""), main = paste("PLS-DA Loading Plot (", scaling, ")", sep="")) 
