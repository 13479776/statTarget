#' @title acu.ROC
#' @description This function provide the receiver operating characteristic curve and Area under the Curve of ROC.
#' @param file The connection to the data in the Univariate file.
#' @importFrom pROC roc
#' @importFrom pROC ci.auc
#' @return A matrix to outline the AUC and the confidence region.
